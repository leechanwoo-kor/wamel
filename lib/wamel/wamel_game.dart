...
import 'package:wamel/wamel/ball.dart';
import 'package:wamel/wamel/car.dart';
import 'package:wamel/wamel/game_colors.dart';
import 'package:wamel/wamel/lap_line.dart';
import 'package:wamel/wamel/lap_text.dart';
import 'package:wamel/wamel/wall.dart';
...
class WamelGame extends Forge2DGame with KeyboardEvents {
  ...
  WamelGame() : super(gravity: Vector2.zero(), zoom: 1);
